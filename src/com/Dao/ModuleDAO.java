...
public class ModuleDAO extends BaseHibernateDAO {
	...
	public Module findById(java.lang.String id) {
		...
		try {
			Module instance = (Module) getSession().get("com.Dao.Module", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Module instance) {
		...
		try {
			List results = getSession().createCriteria("com.Dao.Module").add(
	...
	public List findByDevices(Object devices) {
		return findByProperty(DEVICES, devices);
	}
